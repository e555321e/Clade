...
# 【平衡调整】降低倍率，避免普通压力造成极端死亡率
PRESSURE_TYPE_TIER_MODIFIERS = {
    1: 1.0,  # 轻微压力：标准效果
    2: 1.2,  # 中等压力：1.2倍效果（从1.5降低）
    3: 2.0   # 毁灭压力：2.0倍效果（从2.5降低，真正的大灾难）
}
...
# 【平衡调整】降低倍率，让压力效果更渐进
# 强度 1-3: x1.0 (轻微)
# 强度 4-7: x1.5 (中等，从2.0降低)
# 强度 8-10: x2.5 (极端，从5.0降低)
INTENSITY_TIER_1_LIMIT = 3
INTENSITY_TIER_2_LIMIT = 7

INTENSITY_MULT_1 = 1.0
INTENSITY_MULT_2 = 1.5  # 从 2.0 降低
INTENSITY_MULT_3 = 2.5  # 从 5.0 降低
