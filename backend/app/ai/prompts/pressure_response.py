...
=== 🔥 灾难类压力专项评判（必读）===
以下灾难类压力必须根据物种生态位精准评判：

【火山喷发 volcanic_eruption】强度>=7时：
- ⚠️ 化能自养生物(autotroph + 深海/热泉栖息)：给0.3-0.5（大幅受益！火山带来硫化物和热量）
- ⚠️ 硫细菌等热泉生物：给0.2-0.4（极大受益，这是它们的理想环境）
- 无耐热性(<=5)的物种：直接给1.8-2.0
- 浅海水生物种：受酸雨和毒气影响，给1.5-1.8
- 小型陆生物种：给1.4-1.6（难以逃离）
- 大型陆生物种：给1.2-1.4（可能逃离但仍受影响）
- 深海生物（非热泉）：给1.0-1.2（影响较小）
- 只有地下穴居或极端耐热(>=12)物种才能给<1.0

【硫化事件 sulfide_event / 缺氧事件 anoxic_event】强度>=6时：
- ⚠️ 化能自养生物(如硫细菌)：给0.3-0.5（大幅受益！硫化物是它们的能量来源）
- ⚠️ 厌氧生物：给0.5-0.7（受益，竞争者减少）
- 所有需氧生物：给1.6-2.0
- 低氧适应物种：给0.8-1.0

【海底火山/热泉喷发 submarine_volcanic】任何强度：
- ⚠️ 热泉生物(hydrothermal)：给0.2-0.4（极大受益，栖息地扩张）
- ⚠️ 化能自养生物：给0.3-0.5（受益）
- 深海生物：给0.8-1.0（中性或略有影响）
- 浅海生物：给1.2-1.5（可能受影响）

【极端天气 extreme_weather】强度>=8时：
- 小型物种：给1.5-1.8
- 无运动能力物种（如植物）：给1.6-2.0
- 高机动性物种：给1.0-1.3
- 深海物种：给0.9-1.0（几乎不受影响）

【野火 wildfire_period】强度>=7时：
- 陆生无运动能力物种：给1.8-2.0
- 陆生低机动物种：给1.4-1.7
- 水生物种：给0.9-1.1（几乎不受影响）

=== 🧬 特殊生态位规则（优先级最高）===
以下规则优先于一般灾难规则：

【化能自养生物 (食性=自养生物 + 栖息地=hydrothermal/deep_sea)】
- 对火山喷发、硫化事件：视为有利环境，给0.2-0.5
- 对缺氧事件：不受影响或受益，给0.5-0.8
- 对极端天气、野火：不受影响（深海隔离），给0.9-1.0
- 对海平面下降：可能不利（热泉暴露），给1.2-1.5

【极端环境生物 (耐热性>=10 或 耐盐性>=10)】
- 对温度相关压力：抗性加成，修正系数-0.3
- 对火山喷发：可能受益或中性，给0.7-1.0

=== 📊 压力-特质对应速查表（必须遵循）===
判断物种对压力的适应性时，请对照以下表格：

| 压力类型 | 有利特质 | 不利条件 | 受益物种 |
|----------|----------|----------|----------|
| 降温/冰期 | 耐寒性>=8 | 耐寒性<=3 | 极地生物 |
| 升温/热浪 | 耐热性>=8 | 耐热性<=3 | 沙漠/热泉生物 |
| 干旱 | 耐旱性>=8 | 耐旱性<=3,水生物种 | 沙漠生物 |
| 火山喷发 | 耐热性>=10,化能自养 | 耐热性<=5,浅海生物 | 热泉生物(极大受益) |
| 硫化事件 | 化能自养,厌氧 | 需氧生物 | 硫细菌(极大受益) |
| 缺氧事件 | 氧气需求<=3,厌氧 | 氧气需求>=8 | 厌氧微生物 |
| 海平面上升 | 水生,海岸 | 陆生低地 | 海洋生物 |
| 海平面下降 | 陆生,高地 | 浅海,潮间带 | 陆生生物 |
| 野火 | 水生,穴居 | 陆生植物,低机动 | 水生生物(不受影响) |
